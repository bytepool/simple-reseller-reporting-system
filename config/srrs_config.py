...
report_template_file_fqn = path.join(report_dir_fqn, report_template_file)
email_template_file_fqn = path.join(report_dir_fqn, email_template_file)
...
customer_reg_first_customer_row = 3 # kund 101 starts here
bookings_first_row = 5 # H02 starts here
